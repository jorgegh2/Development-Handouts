...
void j1App::FinishUpdate()
{
	...
	time_to_wait_total = 1000 / framerate_cap;

	if (last_frame_ms < time_to_wait_total)
	{
		time_to_wait = time_to_wait_total - last_frame_ms;
		Timer.Start();
		SDL_Delay(time_to_wait);
		LOG("We have to wait %i millisecons and got back in %f", time_to_wait, Timer.ReadMs());
	}
